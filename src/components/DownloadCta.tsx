    ...
    <section id="download" className="relative overflow-hidden py-24 sm:py-32">
      ...
      <div className="mx-auto flex max-w-3xl flex-col items-center px-6 text-center">
        ...
        <h2 className="text-balance text-3xl font-bold text-ink sm:text-4xl">
          Twoja drużyna kotów czeka
        </h2>
        <p className="text-balance mt-4 max-w-lg text-ink-muted">
          Za darmo, bez konta (choć konto trzyma postęp między urządzeniami). Zainstaluj w
          niecałą minutę i wejdź do gry.
        </p>
        <a
